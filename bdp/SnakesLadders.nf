...
THEORY ListInvariantX IS
  ...
  List_Invariant(Machine(SnakesLadders))==(playerPosition: Squares & playerPosition<=100 & numOfSnakesMet: NAT & numOfLaddersMet: NAT & numOfTurns: NAT & playerRoute: seq(INTEGER) & diceRoll: NAT & diceRoll<=6 & lastDieValue: NAT1 & lastDieValue<=6 & gameStatus <: GAME_STATUS)
END
&
...
THEORY ListInitialisationX IS
  Expanded_List_Initialisation(Machine(SnakesLadders))==(playerPosition,numOfSnakesMet,numOfLaddersMet,numOfTurns,playerRoute,diceRoll,lastDieValue,gameStatus:=1,0,0,0,[1],0,1,{GameNotOver});
  Context_List_Initialisation(Machine(SnakesLadders))==(skip);
  List_Initialisation(Machine(SnakesLadders))==(playerPosition:=1 || numOfSnakesMet:=0 || numOfLaddersMet:=0 || numOfTurns:=0 || playerRoute:=[1] || diceRoll:=0 || lastDieValue:=1 || gameStatus:={GameNotOver})
END
&
...
THEORY ListSubstitutionX IS
  ...
  Expanded_List_Substitution(Machine(SnakesLadders),NewGame)==(btrue | playerPosition,numOfSnakesMet,numOfLaddersMet,numOfTurns,playerRoute,diceRoll,lastDieValue,gameStatus:=1,0,0,0,[1],0,1,{GameNotOver});
  List_Substitution(Machine(SnakesLadders),NewGame)==(playerPosition:=1 || numOfSnakesMet:=0 || numOfLaddersMet:=0 || numOfTurns:=0 || playerRoute:=[1] || diceRoll:=0 || lastDieValue:=1 || gameStatus:={GameNotOver});
